    ...
    public void moveTo(Location newLoc) throws InvalidMoveException {
        if (( newLoc.getRow() >= 0 && newLoc.getRow() <= 7 && newLoc.getCol()>= 0 && newLoc.getCol() <= 7)) {
            if (newLoc.getCol() > getLocation().getCol()) {
                if (newLoc.getRow() > getLocation().getRow() && (Math.abs(newLoc.getCol())-getLocation().getCol() == Math.abs(newLoc.getRow())-getLocation().getCol())) {
                ...
                else if (newLoc.getRow() < getLocation().getRow() && (Math.abs(newLoc.getCol())-getLocation().getCol() == Math.abs(newLoc.getRow())-getLocation().getCol())){
